...
function Message() {
  ...
  return (
    ...
    <div className={`flex w-full h-full relative`}>
      ...
      {
        userLoading ? (<div className='flex justify-center items-center mx-auto'><Spinner/></div>) : (<>
          {/* user */}
              ...
              selectUser ? (
                <div className='w-full h-full flex flex-col'>
                  ...
                  <div className='p-6 max-h-[80%] min-h-[80%] overflow-y-auto'>
                    {
                      loading ? (<div className='flex justify-center items-center mx-auto my-auto'><Spinner /></div>) : (messages && messages.map((message, index) => {
